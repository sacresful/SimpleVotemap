    ...
    public class SimpleVotemap : PRoConPluginAPI, IPRoConPluginInterface
    {
        ...
        private void ProcessChatMessage(string speaker, string message)
        {
            ...
            if (match.Success && cpPlayerPrivs.CanUseMapFunctions)
            {
                ...
                {
                    this.ExecuteCommand("procon.protected.send", "admin.say", "DOMINATION", "all", speaker);
                ...
                {
                    this.ExecuteCommand("procon.protected.send", "admin.say", "OBLITERATION", "all", speaker);
                ...
                {
                    this.ExecuteCommand("procon.protected.send", "admin.say", "REST", "all", speaker);
